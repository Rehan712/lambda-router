...
mod tests {
    ...
    fn test_nested_paths() {
        let matcher = PathMatcher::new("/api/chatbots/:chatbotId/conversations/:conversationId");
        
        let params = matcher.matches("/api/chatbots/chatbot123/conversations/conv456").unwrap();
        assert_eq!(params.get("chatbotId"), Some(&"chatbot123".to_string()));
        assert_eq!(params.get("conversationId"), Some(&"conv456".to_string()));
    }
}
